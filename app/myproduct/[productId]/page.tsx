...
// import myproducts from '@/app/mydb/mydata';
...
//         const foundProduct = myproducts.find((p: productType1) => p.id === productid);
...
//             />
//             <h1 className="text-xl font-bold mb-2 text-orange-950">{myproductsproduct.name}</h1>
//             <p className="text-[#856d63] mb-2">{myproducts.description}</p>
...
const ProductPage = ({ params }: { params: { productId: string } }) => {
  ...
  return (
    <div>
      <Header />
      <div>
        <h1 className="text-center text-3xl md:text-4xl font-extrabold m-6 md:mt-16 text-red-950">Your Cart</h1>
        <div className="p-4 max-w-md mx-auto bg-[#ebdfd9] shadow-lg rounded-lg md:px-12">
          <div className="mb-4">
            <Image
              src={product.image}
